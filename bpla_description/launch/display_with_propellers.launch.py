...
def generate_launch_description():
    ...
    # Мост RPM → joint_states (должен запуститься ПЕРВЫМ)
    ...
    # robot_state_publisher с задержкой (ждёт joint_states)
    ...
    return LaunchDescription([propeller_bridge, delayed_rsp, rviz])
